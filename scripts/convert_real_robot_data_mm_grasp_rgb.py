...
save_data_path = '/home/yxt/thesis/yirui/imitation/3D-Diffusion-Policy/3D-Diffusion-Policy/data/1-12-complete/pick-place-kinect-rs-rgb.zarr'
...
for demo_dir in demo_dirs:
    ...
    for step_idx in range(demo_length):
        ...
        obs_image = demo['azure_rgb'][step_idx]
        new_image = preproces_image(obs_image)
