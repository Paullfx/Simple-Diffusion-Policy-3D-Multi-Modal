...
class SimpleDP3MMProj(BasePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        cprint(f"train gripper length: {self.train_gripper_length} m", "yellow")
    ...
    def conditional_sample(self, 
        ...
        for t in scheduler.timesteps:
            ...
            # 4. apply projection
            if infernce_step >= 7:
                trajectory = self.projection(pose, trajectory, condition_data.device)
    ...
    def projection(self, pose, x_init, device):
        ...
        for b in range(B):
            ...
            lbg = ca.vertcat(0, lbg2)   # Lower bound for g1 and g2
            ...
            print("original x_init_dm: ", x_init_dm)
            print("x_proj_vars: ", x_proj_vars)
