...
class SimpleDP3ProjFlagUpAndDown(BasePolicy):
    def __init__(self, 
            shape_meta: dict,
    ...
    def conditional_sample(self, 
            ...
            generator=None, cur_pose=None, Da=None, start=None, end=None, adopt_flag=None,
    ...
    def predict_action(self, act, robot_cur_pose, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        """
        ...
        nsample = self.conditional_sample(
            ...
            cur_pose=cur_pose, Da=Da, start=start, end=end, adopt_flag=self.adopt_flag,
            **self.kwargs)
        sample_end_time = time.time()
        cprint(f"Sample time: {sample_end_time - start_time:.3f}s", "green")
    ...
    def projection(self, pose, x_init, device, adopt_flag):
        ...
        for b in range(B):
            ...
            for t in range(T):
                ...
                # if adopt_flag[b] == True:
                #     print('constrained height:', (cumulative_pose[2] + x_init_np[b, t, 2] - self.train_gripper_length))
                # else:
                #     print('constrained height:', (cumulative_pose[2] + x_init_np[b, t, 2] - self.end_effector_length))
